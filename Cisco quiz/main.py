...
def quiz_topic(topic):
    ...
    for q in question_keys:
        ...
        if isinstance(correct_info, dict):
            #check if correct_info is instantiated by the 'dict' class. 
            #returns true or false. 
            correct_answer = correct_info["answer"]
            note = correct_info.get("notes")
            #get returns the value of key "note" if there. Otherwise it returns the default None.
        else:
    ...
    while True:
        ...
        if choice in TOPICS:
            if choice == "0":
                ...
                # choise is a string "key" value. TOPICS[choice] returns the value.
        else:
