questions = {
    ...
    "In which class of PA belongs 'Next-hop'?": {
        "answer":"Well-known mandatory attribute",
        "notes": "Well-known mandatory attributes must be implemented and understood by all BGP implementations."
        }, 
    "In which class of PA belongs 'Paths and Origin'?": {
        "answer":"Well-known mandatory attribute",
        "notes": "Well-known mandatory attributes must be implemented and understood by all BGP implementations."
        },
    "In which class of PA belongs 'MED'?": {
        "answer":"Optional non-transitive",
        "notes": "Multifield Exit Discriminator. "
        },
    "When a connected network is matched with the 'network' statement, what is the next-hop IP?": {
        "answer":"0.0.0.0",
        "notes": "Next-hop IP 0.0.0.0; origin is 'i' and the weight is 32768."
        },
    "When a static route or routing protocol route is matched with the 'network' statement, what is the next-hop IP?": {
        "answer":"Next-hop IP of the RIB",
        "notes": "Next-hop IP of the RIB; origin is 'i', the weight is 32768 and the MED is set to the IGP metric"
        },
