...
# https://github.com/mr-awk/juniper_fw_xml_to_xlsx
# Input is the XML file with Juniper SRX security policies:
...
def main():
    tree = ET.parse('FW-HVS-113-DC01_2025-10-22.xml')
    root = tree.getroot()
    ...
    writer = pd.ExcelWriter('FW-HVS-113-DC01_2025-10-22.xlsx', engine='xlsxwriter')
